...
export interface SiteSettings {
    ...
    isRamadanModeEnabled: boolean; // New: Ramadan Mode Toggle
    isShowRamadanCarousel: boolean; // New: Specific Toggle for Carousel Swap
    is_maintenance_mode_enabled: boolean; // New: Maintenance Mode Flag
}