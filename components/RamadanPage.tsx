...
const RamadanPage: React.FC<RamadanPageProps> = ({ allContent, pinnedContent, onSelectContent, siteSettings, isLoggedIn, myList, onToggleMyList, ads, adsEnabled, onNavigate, isLoading }) => {
  ...
  const carousels = useMemo(() => {
    ...
    // Renamed strictly to 'أحدث الإضافات', added isNew: true for badge
    const recentAdditions = limit([...allRamadanContent]
      .sort((a, b) => new Date(b.updatedAt || b.createdAt).getTime() - new Date(a.updatedAt || a.createdAt).getTime()));

    // B. Top 10 Ramadan (Best Rated/Viewed) - LIMIT 10
    // Added Moon Emoji
    const topRated = [...allRamadanContent]
      .sort((a, b) => b.rating - a.rating)
      .slice(0, 10); // Strictly 10 for Top 10
    ...
    const definedCarousels = [
        ...
        },
        {
            ...
            contents: topRated,
            showRanking: true, // New: Show numbers 1-10
