                ...
                <div className="p-6">
                    {success ? (
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-bold text-gray-400 mb-1">تفاصيل إضافية (اختياري)</label>
                                <textarea 
                                    value={description}
                                    onChange={(e) => setDescription(e.target.value)}
                                    className="w-full bg-gray-900 border border-gray-700 rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:border-[var(--color-accent)] resize-none"
                                    rows={2}
                                    placeholder="أي تفاصيل أخرى تساعدنا..."
                                />
                            </div>
                            ...
                            <button 
                                ...
                                className={`w-full ${btnBg} text-white font-bold py-3 rounded-xl shadow-lg transition-all transform active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed mt-2`}
                            >
