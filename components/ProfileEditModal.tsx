            ...
            <div className="flex gap-4 overflow-x-auto rtl-scroll pb-2">
                {avatars.map(av => (
                    <div 
                        ...
                        className={`flex-shrink-0 w-16 h-16 md:w-20 md:h-20 rounded-full overflow-hidden cursor-pointer transition-all duration-200 border-2 ${avatar === av ? 'border-[#00A7F8] scale-110 shadow-[0_0_10px_rgba(0,167,248,0.5)]' : 'border-transparent hover:border-gray-500'}`}
                    >
            ...
            <div className="bg-gray-800 rounded-2xl shadow-xl w-full max-w-2xl text-white animate-fade-in-up border border-gray-700" onClick={e => e.stopPropagation()}>
                <div className="p-6 md:p-8 max-h-[90vh] overflow-y-auto custom-scrollbar">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-6 mb-8 bg-gray-700/30 p-4 rounded-xl border border-gray-700">
                        <div className="w-24 h-24 md:w-32 md:h-32 rounded-full overflow-hidden ring-4 ring-[#00A7F8] flex-shrink-0 shadow-lg">
                        ...
                        <div className="w-full">
                            ...
                            <input 
                                ...
                                className="w-full bg-gray-900 border border-gray-600 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#00A7F8] text-white placeholder-gray-500"
                            ...
                            <div className="mt-4">
                                <label className="flex items-center gap-3 cursor-pointer p-2 hover:bg-gray-700/50 rounded-lg transition-colors w-fit">
                                    <input 
                                        ...
                                        className="w-5 h-5 rounded accent-[#00A7F8] bg-gray-600 border-gray-500 focus:ring-2 focus:ring-offset-0 focus:ring-offset-gray-800 focus:ring-[#00A7F8]"
                                    />
                    ...
                    <div className="mb-6">
                        <h3 className="text-lg font-bold text-[#00FFB0] mb-4">اختر صورة رمزية</h3>
                    ...
                    <div className="flex justify-between items-center mt-8 pt-6 border-t border-gray-700">
                        ...
                        <div className="flex gap-3">
                            ...
                            <button onClick={handleSave} className="bg-gradient-to-r from-[#00A7F8] to-[#00FFB0] text-black font-bold py-2 px-8 rounded-lg hover:bg-white transition-colors shadow-lg text-sm transform hover:scale-105">
                                حفظ
                            </button>
                        </div>
                    </div>
