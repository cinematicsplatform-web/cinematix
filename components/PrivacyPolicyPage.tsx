...
const PrivacyPolicyPage: React.FC<PrivacyPolicyPageProps> = ({ content, onSetView }) => {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-body)] text-white p-4 sm:p-6 lg:p-8 pt-24 animate-fade-in-up">
      <div className="max-w-4xl mx-auto">
        <button onClick={() => onSetView('home')} className="text-gray-400 hover:text-white mb-8 transition-colors">
