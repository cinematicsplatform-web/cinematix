...
const SoonPage: React.FC<SoonPageProps> = ({ allContent, pinnedContent, onSelectContent, isLoggedIn, myList, onToggleMyList, ads, adsEnabled, isLoading, isRamadanTheme }) => {
  ...
  // 🎯 Hero Section Logic:
  // - If Admin pinned items for 'soon' page exist -> Show them.
  // - Else -> Show ONLY the single latest added Soon content.
