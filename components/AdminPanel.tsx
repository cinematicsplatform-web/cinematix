            ...
            <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 pb-10">
                <div className="mb-8 overflow-x-auto py-2 rtl-scroll">
                    <div className="flex gap-2">
                        {(['dashboard', 'content', 'top_content', 'top10', 'stories', 'users', 'requests', 'ads', 'themes', 'settings', 'analytics', 'notifications'] as AdminTab[]).map(tab => (
                            <button 
                                key={tab} 
                            ...
                            >
                                { {dashboard: 'نظرة عامة', content: 'المحتوى', top_content: 'المحتوى المثبت (Hero)', top10: 'إدارة التوب 10', stories: 'إدارة الستوري', users: 'المستخدمون', requests: 'الطلبات', ads: 'إدارة الإعلانات', themes: 'المظهر', settings: 'إعدادات الموقع', analytics: 'الإحصائيات', notifications: 'إرسال إشعار'}[tab] }
                            </button>
                        ))}
                    </div>
                </div>
