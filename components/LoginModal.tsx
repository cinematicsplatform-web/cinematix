...
const LoginModal: React.FC<LoginModalProps> = ({ onSetView, onLogin, isRamadanTheme }) => {
    ...
    const linkColorClass = isRamadanTheme ? 'text-amber-500 hover:text-amber-400' : 'text-[#00A7F8] hover:text-[#00FFB0]';
