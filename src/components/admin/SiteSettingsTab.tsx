        ...
        <div className="space-y-6 max-w-5xl mx-auto">
            ...
            <div className="bg-[#1f2937] p-8 rounded-2xl border border-gray-700/50 shadow-xl space-y-6">
                ...
                <div className="flex flex-col gap-4">
                    <div className="flex items-center justify-between p-4 bg-gray-800/50 rounded-xl border border-gray-700/50">
                        <div className="flex flex-col">
                            <span className="font-bold text-sm text-white">تفعيل إغلاق الموقع</span>
                            <span className="text-[10px] text-gray-500">إغلاق المنصة بالكامل للزوار بشكل نهائي أو مؤقت مع عرض رسالة الإغلاق.</span>
                        </div>
                        <ToggleSwitch checked={siteSettings.is_closure_mode_enabled ?? false} onChange={(c) => handleChange('is_closure_mode_enabled', c)} />
                    </div>
                    <div className="flex items-center justify-between p-4 bg-gray-800/50 rounded-xl border border-gray-700/50">
                        <div className="flex flex-col">
                            <span className="font-bold text-sm text-white">وضع الصيانة للزوار</span>
                            <span className="text-[10px] text-gray-500">تحويل الموقع لوضع الصيانة مع إمكانية عودته للعمل قريباً.</span>
                        </div>
