...
export interface Content {
  ...
  autoEpisodeNotification?: boolean; // هل نرسل إشعار تلقائي لكل حلقة جديدة؟
  autoScheduledEpisodeNotification?: boolean; // هل نرسل إشعار تلقائي للحلقات المجدولة؟
  notificationSent?: boolean; // هل تم إرسال إشعار النشر بالفعل؟
  logoUrl?: string; 
...
export interface SiteSettings {
    ...
    is_closure_mode_enabled: boolean;
